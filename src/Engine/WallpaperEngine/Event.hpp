...
struct EventMemberDesciptorBase
    : meta::MetaObjectT<&EventMemberDesciptorMetaType> {
    explicit EventMemberDesciptorBase(size_t type_hash)
        : meta::MetaObjectT<&EventMemberDesciptorMetaType>(),
...
struct EventMemberDesciptor : EventMemberDesciptorBase {
    ...
    EventMemberDesciptor(T EventBase::*member = nullptr)
        : EventMemberDesciptorBase(typeid(T).hash_code()), m_member(member) {}
    ...
    static EventMemberDesciptor* FromObject(meta::MetaObject* object) {
        ...
        if (typeid(T).hash_code() !=
            static_cast<EventMemberDesciptorBase*>(object)->m_type_hash) {
            return nullptr;
        }
